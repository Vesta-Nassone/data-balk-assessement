...
const MainContent = () => {
    return (
        <div className="bg-white">
            ...
            <div className="w-full h-[500px] flex flex-col lg:flex-row items-center justify-center py-8">
                {/* Image */}
                <div className="relative flex justify-center mb-4 lg:mb-0">
                    <img src={buildingImage} alt="view" className="w-[496px] h-[372px] object-cover z-20 rounded-xl" />
                    <div className='absolute w-[254px] h-[274px] top-[-48px] left-[-64px] transform rotate-[108.85deg]'>
                ...
                <div className="w-[596px] h-[372px] text-left">
                    <h2 className="font-overlock text-[32px] text-[#35BCE7] lg:text-4xl font-bold mb-4 pt-0">
                        We verbeteren onze woningen
                    </h2>
                    <p className="font-poppins text-base font-normal text-black mb-4">
                        ...
                        <span className='pt-2'>
                            <br /><br />Wilt u meer weten over onze energiebesparende maatregelen?
                        </span>
                    </p>
                    {/* Button */}
                    <button className="w-[131px] h-10 text-white text-base font-[500] px-6 py-2 mt-5 rounded-lg" style={{
            ...
            <div className="bg-[#9AA4D9] w-full h-[572px] flex flex-col items-center justify-center py-8">
                <div className='font-poppins'>
                    <h3 className='font-overlock text-[#39468C] font-bold text-[32px] mb-4'>Laatste nieuws</h3>
                    <div className='flex flex-wrap justify-center gap-5'>
                        {/* Card 1 */}
                        <div className='relative bg-white w-[288px] h-[346px] rounded-xl shadow-xl'>
                            <img src={card1} alt="card 1" className='w-full h-[160px] rounded-t-xl rounded-b-0' />
                            <div className='w-[264px] mx-auto p-1'>
                                <p className='text-[11px] text-[#999999] font-semibold uppercase mt-3'>5 maart 2024</p>
                                <h5 className='text-[#39468C] font-overlock text-xl font-bold mt-2'>Telefoonstoring</h5>
                                <p className='text-[#39468C] text-sm mt-2'>Update: Telefoonstoring verholpen</p>
                        ...
                        {/* Card 2 */}
                        <div className='relative bg-white w-[288px] h-[346px] rounded-xl shadow-xl'>
                            <img src={clock} alt="card 1" className='w-full h-[160px] rounded-t-xl rounded-b-0' />
                            <div className='w-[264px] mx-auto p-1'>
                        ...
                        {/* Card 3 */}
                        <div className='relative bg-white w-[288px] h-[346px] rounded-xl shadow-xl'>
                            <img src={warehouse} alt="card 1" className='w-full h-[160px] rounded-t-xl rounded-b-0' />
                            <div className='w-[264px] mx-auto p-1'>
                                <p className='text-[11px] text-[#999999] font-semibold uppercase mt-3'>
                                    30 januari 2024
                                </p>
                                ...
                                <p className='text-[#39468C] text-sm mt-2 pb-5'>
            ...
            <div className="w-full h-[500px] flex flex-col lg:flex-row items-center justify-center py-8">
                {/* Text Section */}
                <div className="relative w-[597px] h-[372px] text-left px-4">
                    <h2 className="font-overlock text-[32px] text-[#FF6B38] lg:text-4xl font-bold mb-4">
                        Schrijf je in voor onze nieuwsbrief
                    </h2>
                    <p className="font-poppins text-base font-normal text-black mb-3">
                        Bij KnusWonen zetten we ons in om onze woningen energiezuiniger en duurzamer te maken. We verbeteren de isolatie met dubbelglas en plaatsen moderne cv-ketels en zonnepanelen. Hierdoor stijgt het wooncomfort, dalen de energiekosten, en verminderen we de CO2-uitstoot. Ons doel is dat al onze huurders kunnen genieten van een warme, veilige en toekomstbestendige woning.
                        <span className='pt-2'>
                            <br /><br />Wilt u meer weten over onze energiebesparende maatregelen?
                        </span>
                    ...
                    {/* Button */}
                    <button className="absolute w-[131px] h-10 text-white text-base font-[500] rounded-lg mt-3" style={{
                ...
                <div className="relative flex justify-center">
                    <img src={inbox} alt="view" className="w-[498px] h-[372px] object-cover z-20 rounded-xl" />
                    <div className='absolute w-[140.3px] h-[171.3px] bottom-[-12px] right-[-38px] transform rotate-[18.66deg]'>
